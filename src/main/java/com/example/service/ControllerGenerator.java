...
public class ControllerGenerator {
	...
	private final void write(OutputStream out, String content) throws IOException {
	 ...
	 public boolean generateController(OutputStream out, String packageName, String sObjectName) throws IOException {
		   ...
		   write(out, TAB + "}" + NEWLINE + NEWLINE);
				   ...
				   write(out, TAB + TAB + "QueryResult<"+ sObjectName +"> res = api.query(\"SELECT id FROM "+ sObjectName +"\", " + sObjectName + ".class);" + NEWLINE);
	 ...
	 public static void main(String[] args) throws IOException {
		 ...
		 cg.generateController(output, "com.thysmichels.controller", "Account");
	 } 
}
